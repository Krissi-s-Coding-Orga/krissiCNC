...
#define HOMING_BUMP_MM      { 2, 2, 0 }       // (linear=mm, rotational=°) Backoff from endstops after first bump
...
#define CUSTOM_MENU_MAIN
  ...
  #define MAIN_MENU_ITEM_1_DESC "Zero X"
  #define MAIN_MENU_ITEM_1_GCODE "G92 X0"
  //#define MAIN_MENU_ITEM_1_CONFIRM          // Show a confirmation dialog before this action

  #define MAIN_MENU_ITEM_2_DESC "Zero Y"
  #define MAIN_MENU_ITEM_2_GCODE "G92 Y0"
  //#define MAIN_MENU_ITEM_2_CONFIRM

  #define MAIN_MENU_ITEM_3_DESC "Zero Z"
  #define MAIN_MENU_ITEM_3_GCODE "G92 Z0"
  //#define MAIN_MENU_ITEM_3_CONFIRM

  #define MAIN_MENU_ITEM_4_DESC "Zero ALL"
  #define MAIN_MENU_ITEM_4_GCODE "G92 X0 Y0 Z0"
